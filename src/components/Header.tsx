...
const Header = () => {
  ...
  return (
    ...
    >
      <div className='flex fixed w-fit top-1/2 -translate-y-1/2 right-4 sm:absolute sm:left-8 sm:translate-y-0 z-30 lg:absolute lg:left-8 lg:top-1/2 lg:-translate-y-1/2 mr-auto '>
        <ThemeSwitcher />
      </div>
      ...
      <div className='relative hidden lg:flex items-center justify-center gap-8 3xl:gap-12 4xl:gap-16'>
        <nav className='flex items-center gap-8 3xl:gap-12 4xl:gap-16 w-[475px] justify-end'>
        ...
        <nav className='flex items-center gap-8 3xl:gap-12 4xl:gap-16 w-[475px]'>
